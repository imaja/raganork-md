...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '༒͢🦋⃟ᎬXᎢ░ 𝚂𝙰𝙶𝙰𝚁༒͢;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "༒͢🦋⃟ᎬXᎢ░ 𝚂𝙰𝙶𝙰𝚁༒͢",
    BOT_NAME: process.env.BOT_NAME || '༒͢🦋⃟ᎬXᎢ░ 𝚂𝙰𝙶𝙰𝚁༒͢',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;༒͢🦋⃟ᎬXᎢ░ 𝚂𝙰𝙶𝙰𝚁༒͢ MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
